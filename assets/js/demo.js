...
(function() {
  ...
  window.CanvasSlideshow = function( options,spriteImages ) {
    ...
    let title = document.querySelector('.title__1');
      ...
      navItem.onclick = function( event ) {
        ...
        if ( this.getAttribute('data-nav') === 'next' ) {
          ...
          if ( that.currentIndex >= 0 && that.currentIndex < slideImages.length - 1 ) {
            ...
            textData.to('.title__1',2,{
              clipPath:"inset(200px)",
              x:-40,
              ease:"Expo.easeOut",
              onComplete:()=>{
                title.textContent = titles[that.currentIndex]
              }
            })
            textData.to('.title__1',2,{clipPath:"inset(0)", x:0,ease:"Power4.easeOut"})
            ...
            textData.to('.title__1',2,{
              ...
              ease:"Expo.easeOut",
              onComplete:()=>{
                title.textContent =  title.textContent = titles[2]
              }
            })
           
            textData.to('.title__1',2,{clipPath:"inset(0)", x:0,ease:"Expo.easeOut"})
